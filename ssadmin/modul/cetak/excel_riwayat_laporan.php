...
$title = "Laporan Kinerja Karyawan - " . date('Y-m-d');
...
<table border="1">
    ...
    @$tanggal1 = $_POST['tanggal1b'];
    @$tanggal2 = $_POST['tanggal2b'];
    //echo $nama_karyawan;
    @$tabel = "v_lapharian";
    @$field_id = "id_harian";
    @$urutan = "desc";
    ...
    <thead>
        <tr>
            <th colspan="14" style="text-align: center;">
                <h3>LAPORAN KINERJA HARIAN <br><b><?= strtoupper($data1['nama_lengkap']) ?></b> <br> Periode <?= tgl_indo($tanggal1) ?> s/d <?= tgl_indo($tanggal2) ?></h3>
            </th>
        </tr>
        <tr>
            <th>No.</th>
    ...
    <tbody>
        ...
        $tampilx = tampil($tabel, "where id_karyawan = '$id_karyawan' and tanggal BETWEEN '$tanggal1' and '$tanggal2' order by id_harian desc");
    ...
    <tr>
        ...
        <td colspan="3" align="left"><b><?= @$total_nilai ?></b></td>
    </tr>
</table>