<div class="row">
	<div class="col-xs-12">
		<h3 class="header smaller lighter blue">Data Karyawan/Staff</h3>
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	      	 <div class="form-group">
			    <label for="address" class="col-sm-4 control-label">NIP</label>
			    <div class="col-sm-8">
			      <input type="text" class="form-control" id="nip" name="nip" placeholder="NIP Pengguna">
			    </div>
			  </div>
			   <div class="form-group">
			    <label for="address" class="col-sm-4 control-label">Nama</label>
			    <div class="col-sm-8">
			      <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" placeholder="Nama Lengkap Pengguna">
			    </div>
			  </div>
			  <div class="form-group">
				<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Jabatan </label>
				<div class="col-sm-8">
			  ...
			  <div class="form-group">
				<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Data Atasan / Pejabat Penilai </label>
				<div class="col-sm-8">
			  ...
			  <div class="form-group">
				<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Data Atasan dari Atasan / Atasan Pejabat Penilai </label>
				<div class="col-sm-8">
			...
			<div class="form-group">
				<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Status Aktif </label>
				<div class="col-sm-4">
					<select class="form-control"  name="status" id="status" data-placeholder="--Pilih--" disabled>
			...
			<div class="form-group">
			  	 <label for="address" class="col-sm-4 control-label">Foto</label>
				<div class="col-xs-7">
...
var main = "modul/karyawan/set_atasan/";
