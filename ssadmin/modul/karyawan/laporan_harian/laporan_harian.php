	   ...
	   <div class="modal-dialog modal-lg" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
			  ...
			  <div class="form-group">
			    <label for="name" class="col-sm-3 control-label">Waktu Mulai</label>
			   <div class="col-sm-4"> 
			  ...
			  <div class="form-group">
			    <label for="name" class="col-sm-3 control-label">Waktu Selesai</label>
			   <div class="col-sm-4"> 
			   <div class="input-group bootstrap-timepicker ">
			...
			<div class="form-group">
			    <label for="address" class="col-sm-3 control-label">Lama Pengerjaan</label>
			    <div class="col-sm-4">
					<div class="input-group">
			 ...
			 <div class="form-group">
			    <label for="name" class="col-sm-3 control-label">Deskripsi Pekerjaan</label>
			    <div class="col-sm-9"> 
			 ...
			 <div class="form-group">
			    <label for="address" class="col-sm-3 control-label">Output</label>
			    <div class="col-sm-9">
			  ...
			  <div class="form-group">
			    <label for="name" class="col-sm-3 control-label">File Pekerjaan</label>
			    <div class="col-sm-9"> 
...
$('#waktu_mulai').change(function(){
	...
	var jam_x = parseInt(x.substring(0,2)) * 3600 ;
	var jam_y = parseInt(y.substring(0,2)) * 3600 ;
	var menit_x = parseInt(x.substring(3,5)) * 60;
	var menit_y = parseInt(y.substring(3,5)) * 60;

	var detik_x = parseInt(x.substring(6,8));
	var detik_y = parseInt(y.substring(6,8));

	var hasil_x = jam_x + menit_x + detik_x;
	var hasil_y = jam_y + menit_y + detik_y;
