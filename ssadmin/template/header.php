...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title><?=$title?></title>
		<link rel="shortcut icon" href="../assets/images/Unindra PGRI.png" />
					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<?php $level = escape($_SESSION['level']); if($level == "Operator"){?>
									<img class="nav-user-photo" src="../file/foto_user/<?=$_SESSION['foto']?>"/>
								<?php }elseif($level == "Karyawan"){ ?>
								<img class="nav-user-photo" src="../file/foto_karyawan/<?=$_SESSION['foto']?>"/>
								<?php }?>
